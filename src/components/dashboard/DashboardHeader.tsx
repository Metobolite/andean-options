...
function DashboardHeader() {
  return (
    <header className="flex min-h-[96px] items-center justify-between gap-5 border-b border-slate-200 bg-white px-7 max-md:flex-col max-md:items-stretch max-md:px-5 max-md:py-5">
      <div>
        <h1 className="mb-2 text-[24px] font-bold leading-none text-black">
          Regional Farms Dashboard
        </h1>
        <p className="m-0 text-[0.78rem] font-bold text-[#6B7280]">
